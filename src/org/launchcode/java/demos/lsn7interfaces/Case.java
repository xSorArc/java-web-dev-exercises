...
public class Case {
    ...
    public Case() {
        ...
        Topping topping1 = new Topping("Sprinkles", 0.00, new ArrayList<>(Arrays.asList("none")));
        Topping topping2 = new Topping("Fudge", 0.00, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping3 = new Topping("Caramel", 0.00, new ArrayList<>(Arrays.asList("gluten")));
